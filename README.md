...
Почему не крутим контент повторно на тех, кого уже собрали? Потому что **на этапе прогрева это не работает**. Ретаргет по той же аудитории — это просто платить Facebook в ~4 раза дороже без смысла. Ретаргетинг имеет смысл только для **лидогенерящих кампаний** — и вот там мы его обязательно включим, на этапе закрытия. И важно: вся эта аудитория **никуда не пропадает** — каждый, кто смотрел ролики, заходил в профиль или писал, копится в пикселе и вовлечённых аудиториях Меты. Это и есть **база, по которой запустим лидген**: мы её не бросаем — мы её складируем для закрытия.
