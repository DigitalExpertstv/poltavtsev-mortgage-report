...
И вывод «надо делать лидген» — верный. Вопрос только в том, **как его делать, когда и какими методами**. Если в лоб — это не работает: мы уже видим это на цифрах, так как пробовали, и [исследования](research-appendix.md#1-прогрев-доверия-до-лидгена) говорят о том же.
...
**Сильные:**
- **Системная, дисциплинированная схема** — идём за тем, что подтверждается перепиской, а не за вкусовщиной.
- **Аудиторию изучили насквозь** — знаем боли, заходы и триггеры, с чем люди приходят и на что реагируют. Это фундамент, который другая команда начинала бы с нуля.
- **Контент сильный по голосу** — 171 креатив, живой личный тон, реальные кейсы: ровно то, что строит доверие (и чего не даёт ИИ-аватар).
- **Спрос проверен до стройки воронки** — сайт и 5 лендингов сделаны под уже доказанные боли.
- **Верх воронки работает дёшево** — переписки по $2–5, десятки диалогов.

**Слабые (берём на себя):**
- **Не было регулярной отчётности** — ты не видел, что работает и что меняется. Это наш главный промах: именно из-за него копилось ощущение «деньги уходят, а толку не видно».
- **Кампании согласовывались постфактум**, а не до запуска — ты был не в курсе, что и зачем крутится.
- **Недооценили усталость от съёмок** — не предложили раньше, как разгрузить продакшен. Признаю.
- **Визуал аккаунта разрозненный** — нет единого стиля, ты сам его не любишь. Чиним.

---

## 4. Цена принятых и непринятых решений

Чтобы «цена» читалась в контексте: за работу ты платишь **$1750/мес**. Это плата **не «за лиды», а за постройку маркетинговой машины**. И вот что на неё (плюс ~$2 400 рекламного бюджета) уже построено и остаётся с тобой:

- исследование рынка и аудитории (таблица гипотез + банк голосов);
- стратегия и система JTBD;
- **171 креатив**;
- **сайт и 5 лендингов** под доказанные боли;
- тёплая база: **+931 подписчик**, охват **~114 000**, десятки диалогов;
- отлаженная, проверенная на данных воронка — готовая к лидгену.

«5 лидов» — это не итог этой работы, а выхлоп одного маленького теста внутри неё. А теперь — какие решения внутри мы принимали и чего они стоили:
