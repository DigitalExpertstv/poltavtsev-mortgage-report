...
**Что это значит для стратегии.** YouTube и TikTok здесь — не отдельные каналы привлечения, а **поддерживающие касания**. По кросс-платформенной логике тот же прогретый в Мете человек встречает тебя ещё и в YouTube/TikTok — это дополнительные, **ценные касания**, которые укрепляют доверие и узнаваемость (комментарий-вопрос выше — как раз пример такого касания). Их немного, но ради этого они и делаются. И это подтверждается данными: [кампании на 3+ каналах дают в разы выше отклик, а покупатель в среднем проходит ~6 касаний перед решением](research-appendix.md#9-мультиканальность-и-кросс-платформенные-касания). Саму же **конверсию мы концентрируем на Мете — быстром инструменте**, а YouTube/TikTok/сайт работают на доверие вокруг неё.
