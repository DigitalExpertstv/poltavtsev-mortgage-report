...
3. По технологии и рекомендации FB нужно набрать ~50 событий. **Почему отключили раньше?** Наш опыт по поведению кампаний: мы по совокупности метрик видим, как кампания развивается в первые дни, и когда вероятность, что она «разгонится», низкая — отключаем, чтобы не сливать бюджет. Это ложится на исследования: в доверительных нишах (ипотека) прямой лидген «в лоб» по холодной аудитории работает хуже прогрева — [см. приложение §1](research-appendix.md#1-прогрев-доверия-до-лидгена).
