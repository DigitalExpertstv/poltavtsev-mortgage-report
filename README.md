...
**Что это значит для стратегии.** Результаты есть на всех каналах — но YouTube, TikTok и SEO сайта это **медленные, накопительные** инструменты. Поэтому конверсионную воронку мы строим на **Мете — быстром инструменте**: там прогрев и лидген дают результат в недели. А YouTube/TikTok/сайт работают в долгую, усиливают доверие и время от времени **сами приносят входящие** (как этот комментарий-вопрос).
