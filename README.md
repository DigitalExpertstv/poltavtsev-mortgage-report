...
И контент реально смотрят и досматривают — это видно по сырым метрикам Facebook (досмотры, удержание, вовлечённость): [эффективность контента](content-effectiveness.md). То есть контент — не слабое место.
