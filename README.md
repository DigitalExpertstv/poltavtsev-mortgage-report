...
И контент реально работает: его **кликают выше нормы и по недвижимости, и по финансам** (CTR рилов ~3%, каруселей ~5,3% против 1,68% в недвижимости и 0,98% в финансовой Facebook-рекламе, США 2025), «мёртвых» роликов практически нет, а рилы держат внимание. Подробно, с цифрами и сравнением с рынком: [эффективность контента](content-effectiveness.md). То есть контент — не слабое место.
...
### 1.4. Контент работает и за пределами рекламы — YouTube и TikTok
...
- И главное — **органика уже приносит входящий интерес.** Под роликом про техасскую программу помощи — комментарий: *«Здравствуйте, а как узнать больше об этой программе?»* Это, по сути, **лид, пришедший из контента без всякой рекламы**.
...
**Что это значит для стратегии.** Реклама у нас крутится **только в Мете**. В YouTube и TikTok те же ролики просто **бесплатно кросс-постятся** — дёшево и сердито. Это не отдельные каналы привлечения, а **поддерживающие касания**: прогретый в Мете человек встречает тебя ещё и там, и эти повторные касания в разных местах **укрепляют доверие и узнаваемость** — то есть работают на усиление самой рекламы в Мете (комментарий-вопрос выше — пример живого касания). Механика подтверждается: [кросс-постинг создаёт «эффект вездесущности» и ускоряет узнавание, а платная омниканалка на 3+ каналах поднимает отклик в разы — часть этого мы получаем бесплатно](research-appendix.md#9-мультиканальность-и-кросс-платформенные-касания). Оговорка: изолированно замерить этот вклад нельзя — это обоснованный вывод по механике узнавания. Саму **конверсию концентрируем на Мете — быстром инструменте**.

**И это осознанная последовательность, а не «дёшево и на отвяжись».** Мы ещё достраиваем воронку — а масштабировать в других каналах то, что ещё не достроено, нельзя: получится как с апрельским лидген-тестом (запустили сырое → пусто). Поэтому сейчас: **Мета + бесплатные перепосты**. А когда воронка отстроена и подтверждена — разворачиваем её и в других каналах **уже с платным промоушеном**, чтобы забрать многоканальный прирост эффективности ([до +287% по данным омниканальных кампаний](research-appendix.md#9-мультиканальность-и-кросс-платформенные-касания)). Сначала сделать и проверить — потом масштабировать. Иначе это сжигание денег.

**А дальше — по-крупному.** Следующие этапы — это уже не только органика: YouTube (а YouTube — это реклама **Google**) и TikTok со своим платным продвижением. Там настройка **гораздо серьёзнее, чем у Меты**: свои интеграции, аналитика, дедупликация и обучение алгоритмов. Мы будем **пробрасывать аналитику между площадками** — и вот тут начнётся **настоящая кросс-платформенность** и тот самый кратный рост эффективности ([~+287% из омниканальных данных](research-appendix.md#9-мультиканальность-и-кросс-платформенные-касания)). Но до этого этапа надо **сперва дожить** — достроив и отладив базу на Мете. Всё по очереди.
...
**Сайт — это фундамент настоящего маркетинга, а не соцсети.** Соцсети — быстрый, но «арендованный» канал: перестал постить или платить — поток иссяк, и правила там не твои. Сайт — это **твоя собственная система**, в которую **сходится весь маркетинг**: сюда ведёт реклама, здесь стоят аналитика и пиксель (которые учат Мету), здесь работает SEO и копится органика, отсюда лиды пойдут в CRM, здесь живут лендинги под каждую боль. Грамотно сделанный сайт **собирает все каналы в один управляемый механизм** — и остаётся с тобой навсегда. Этот фундамент мы **уже заложили на серьёзном инженерном уровне** (насколько серьёзном — **[подробно о сайте](site.md)**). Это только начало — но масштаб заложен правильный.

Сайт — не визитка, а часть **закрывающей воронки**. Мы с самого начала планировали начать его на **2–3-й месяц** работы — ровно чтобы он опирался на **аналитику и уже полученный результат** (какие боли дают переписки), а не строился вслепую. Обещание выполнили: **сайт сделан и в срок** — это наш **конвертирующий инструмент**. И у него есть вторая функция — **точка входа, трафик из поиска** (об этом ниже).
...
Абсолютные числа пока небольшие — сайт молодой, блог наполнили только в июне. Но сигнал сильный: сайт **проиндексирован и уже ранжируется по целевым запросам в регионе**, а не только по бренду, да ещё с CTR 20%.
...
И честно, раз подводим итоги: **невычитанные лонгриды притормозили процесс** — я приостановил продакшн и выкладку следующих статей, пока не вычитаны текущие. Я из этого не раздувал проблему, но по факту это **блокер** на твоей стороне.

### Доступ к CRM — для авто-передачи лидов
